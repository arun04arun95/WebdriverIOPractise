...
exports.containsHeaderObject = exports.updateCapabilities = exports.getPuppeteer = exports.getAutomationProtocol = exports.isStub = exports.enhanceElementsArray = exports.getElementFromResponse = exports.getPrototype = void 0;
...
const getPuppeteer = async function getPuppeteer() {
  if (this.puppeteer) {
  ...
  throw new Error('Network primitives aren\'t available for this session. ' + 'This feature is only supported for local Chrome, Firefox and Edge testing.');
};
