...
exports.toHaveProperty = exports.toHavePropertyFn = void 0;
...
function toHavePropertyFn(received, property, value, options = {}) {
...
exports.toHavePropertyFn = toHavePropertyFn;
function toHaveProperty(...args) {
    return expectAdapter_1.runExpect.call(this, toHavePropertyFn, args);
}
