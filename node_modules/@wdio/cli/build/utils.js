...
function getPathForFileGeneration(answers) {
  ...
  const relativePath = answers.generateTestFiles && answers.usePageObjects ? !(answers.framework.short === 'cucumber') ? _path.default.relative(destSpecRootPath, destPageObjectRootPath) : _path.default.relative(destStepRootPath, destPageObjectRootPath) : '';
  return {
