...
exports.QUESTIONNAIRE = exports.SUPPORTED_PACKAGES = exports.TS_COMPILER_INSTRUCTIONS = exports.COMPILER_OPTIONS = exports.IOS_CONFIG = exports.ANDROID_CONFIG = exports.CONFIG_HELPER_SUCCESS_MESSAGE = exports.CONFIG_HELPER_INTRO = exports.EXCLUSIVE_SERVICES = exports.CLI_EPILOGUE = void 0;
...
const TS_COMPILER_INSTRUCTIONS = `To have TypeScript support please add the following packages to your "types" list:
{
  "compilerOptions": {
    "types": ["node", %s]
  }
...
`;
exports.TS_COMPILER_INSTRUCTIONS = TS_COMPILER_INSTRUCTIONS;
const SUPPORTED_PACKAGES = {
  ...
  service: [{
    ...
    name: 'ng-apimock',
    value: 'wdio-ng-apimock-service$--ng-apimock'
  }, {
    name: 'slack',
    ...
    name: 'novus-visual-regression',
    value: 'wdio-novus-visual-regression-service$--$novus-visual-regression'
  }]
};
...
const QUESTIONNAIRE = [{
  ...
  when: () => SUPPORTED_PACKAGES.runner.length > 1
}, {
  type: 'list',
  name: 'backend',
  ...
  default: answers => answers.framework.match(/(mocha|jasmine)/) ? './test/pageobjects/**/*.js' : './features/pageobjects/**/*.js',
  ...
  default: () => (0, _utils.hasFile)('babel.config.js') ? COMPILER_OPTIONS.babel : (0, _utils.hasFile)('tsconfig.json') ? COMPILER_OPTIONS.ts : COMPILER_OPTIONS.nil
}, {
  type: 'checkbox',
  name: 'reporters',
